...
//        MediaSource videoSource = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(liveStreamUri);
        ...
        MediaSource mediaSource = new ExtractorMediaSource(Uri.parse("http://tejweb.com:4700/public/uploads/videoclip/70/70_video_clip-15637943361552019-07-22-16-43-05.mp4"),
